...
<script>
    ...
    KindEditor.ready(function(K) {
        editor = K.create('textarea[name="contenttext"]', {allowFileManager : false});
    });
</script>
...
<td><input type="text" class="input" name="title" size="100" maxlength="90" /><span class="block" id="is_bold">B</span><span class="block" id="is_color">C<div id="colors">
...
<td><input type="text" class="input" name="addtime" size="100" maxlength="20" value="<?php echo date('Y-m-d H:i:s') ?>" /></td>
</tr>

<tr>
<td class="right">文章内容</td>
<td><textarea name="contenttext" style="width:700px;height:300px;visibility:hidden;"></textarea></td>
</tr>

<tr>
<td class="right"></td>
<td>
<input type="checkbox" name="is_popup" value="1" id="c1" /> <label for="c1">允许自动弹出此文章</label>
<input type="checkbox" name="is_display_home" value="1" checked id="c2" /> <label for="c2">允许显示在首页</label>
</td>
</tr>
...
<input type="hidden" name="is_bold" value="">
